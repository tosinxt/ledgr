...
const ledgrPlans = [
    {
        ...
        description: "For freelancers trying it out",
    ...
    },
    {
        ...
        features: [
            "Unlimited invoices",
            "AI Smart Fill for line items & totals",
            "AI payment reminders",
            "Save clients & recurring invoices",
            "Custom branding (logo, colors, no watermark)",
            "Online payments (Paystack/Stripe/Flutterwave)",
            "Multi-currency & basic analytics",
        ],
        description: "For professionals & small businesses",
    ...
    },
    {
        ...
        yearlyPrice: "32",
        priceNGN: "30000",
        yearlyPriceNGN: "25000",
        period: "per month",
        features: [
            "Everything in Pro",
            "AI expense summaries & cashflow forecasts",
        ...
        description: "For SMEs, agencies, and finance teams",
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Introducing AI-Powered Invoice Generation</span>
                                    ...
                                    <p
                                        ...
                                        Streamline your accounting workflow with intelligent invoice generation, automated tracking, and seamless payment processing.
                                    </p>
                                </AnimatedGroup>
...
const Logo = ({ className }: { className?: string }) => {
    return (
        <div className={cn('h-8 w-auto flex items-center space-x-2', className)}>
            <div className="h-8 w-8 bg-gradient-to-br from-blue-500 to-green-400 rounded-lg flex items-center justify-center">
